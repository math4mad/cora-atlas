...
\author{Yiwei Zhang (\textsc{Y\u{i}w\`{e}i}, \texttt{math4mad}) \\ \small The Cora Project --- \texttt{github.com/math4mad}}
\date{\today}
...
The first match was struck in MIT 18.06 \cite{strang}: rank-one matrices and a national flag made me \emph{see} linear algebra; that open letter to Professor Gilbert Strang is archived with this paper. The theory was refined in two weeks of dialogue with AI agents, including the collaborator who insisted that ``sausage'' and ``Gaussian process'' are one shape in two concept spaces. The sharpest early reviewer was a cat named Y\u{i}zi (Chair), who, hearing ``bicycle,'' activated an entirely different space and came home at once.
